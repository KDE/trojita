...
macro(QT5_WRAP_PO outfiles)
   foreach(it ${ARGN})
      ...
      if(NOT I18N_LANGUAGE)
        ...
        string(REGEX MATCH "${I18N_LANGUAGE}" ln ${lang})
        if(ln)
          set(do_wrap ON)
        else()
          set(do_wrap OFF)
      ...
      if(do_wrap)
        ...
        get_filename_component(filenameBase ${it} NAME_WE)
        set(tsfile ${CMAKE_CURRENT_BINARY_DIR}/locale/${filenameBase}_${lang}.ts)
        set(qmfile ${CMAKE_CURRENT_BINARY_DIR}/locale/${filenameBase}_${lang}.qm)
