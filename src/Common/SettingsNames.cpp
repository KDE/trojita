...
const QString SettingsNames::geometry = QStringLiteral("geometry");
const QString SettingsNames::windowState = QStringLiteral("windowState");
const QString SettingsNames::messageListState = QStringLiteral("messageListState");
const QString SettingsNames::messageListHeader = QStringLiteral("messageListHeader");
const QString SettingsNames::columnWidth = QStringLiteral("columnWidth");
const QString SettingsNames::menubarVisible = QStringLiteral("menubarVisible");
const QString SettingsNames::mainVSplitterState = QStringLiteral("mainVSplitterState");
const QString SettingsNames::mainHSplitterState = QStringLiteral("mainHSplitterState");
...
const QString SettingsNames::msgViewColorScheme = QStringLiteral("gui/msgView.colorScheme");
const QString SettingsNames::settingsVersion = QStringLiteral("settings.version");
}
